    ...
    <div id="wrapper">
        ...
        <div id="main">
            ...
            if (isset($_POST['inserting'])) {
                ...
                if (mysqli_query($serverConnection, "INSERT INTO `news` (`news_id`, `title`, `editor`, `content`, `image`, `video_youtube`, `category`, `display`, `display_phone`, `creation`, `comments`) VALUES (NULL, '$title', '$editor', '$content', '$newsImagePath', '$videoYoutube', '$category', '$display', '$display_phone', CURRENT_TIMESTAMP, $comments);")) {
...
<!--                            <img class="imageIcon" src="../images/icon_pdf.png" onClick="clickImageFile();" />
