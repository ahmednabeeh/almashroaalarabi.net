...
<html>
    <head>
        <title>Issues of Homeland</title>
        <meta charset="utf8" />
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="midBar">
                <div id="subPages">
                    <div class="title">Issues of Homeland</div>
                    <div style="text-align: center; margin-top: 10px;">
                        <?php
                        if (mysqli_num_rows(mysqli_query($serverConnection, "SELECT news_id, title, content, image, views FROM news WHERE category = 'قضايا وطن' AND display = 1 AND display_phone = 0 ORDER BY news_id DESC LIMIT  $start, " . PERPAGE)) != 0) {
                            $defaultActivities = mysqli_query($serverConnection, "SELECT news_id, title, content, image, views FROM news WHERE category = 'قضايا وطن' AND display = 1 AND display_phone = 0 ORDER BY news_id DESC LIMIT  $start, " . PERPAGE);
                            $counter = 1;
