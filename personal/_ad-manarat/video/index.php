    ...
    <div id="wrapper">
        <div class="user_info_area">
            ...
            <div class="navigation_bar">
                <a href="display.php"><img title="عرض وتعديل الفيديوهات" style="border: none;" align="absmiddle" src="../images/icon_video_edit.png" width="40" /></a>
            </div><!-- // Navigation Bar -->
        ...
        <div id="main">
            ...
            if (isset($_POST['inserting_video'])) {
                ...
                if (mysqli_query($serverConnection, "INSERT INTO video (title, code, image, display, display_phone, `creation`) VALUES ('$title', '$code', '$videoImagePath', $display, $display_phone, CURRENT_TIMESTAMP)")) {
                    echo "<h2 align=\"center\" style=\"color: #F00;\">تم حفظ الفيديو \"" . $title . "\"</h2>";
                } else {
                    echo "<h2 align=\"center\" style=\"color: #F00;\">لم يتم حفظ الفيديو! \"" . $title . "\"</h2>";
                }
            }
            ?>
            <table border="0" cellspacing="0" cellpadding="0" width="940">
                <!-- News Section -->
                <tr>
                    <td class="section" colspan="4">إضافة فيديو</td>
                </tr>
            </table>
