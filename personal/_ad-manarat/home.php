                ...
                <tr>
                    <td class="tableCellHome" width="200" align="center" valign="middle">
                        ...
                        if ($_SESSION['permission_video_GenerlUseXV1'] == 1) {
                            echo "<a href=\"video_gallery/index.php\">
<img style=\"border: none;\" src=\"images/icon_programs.png\" vspace=\"5\" width=\"70\"/><br />إضافة برنامج</a>";
                        } else {
                            echo "<img onclick=\"return permission();\" style=\"border: none;\" src=\"images/icon_programs_off.png\" vspace=\"5\" width=\"70\"/><br />إضافة برنامج";
                        }
                        ?>
                    </td>
                    ...
                    <td class="tableCellHome" width="200" align="center" valign="middle">
                        <?php
                        if ($_SESSION['permission_video_GenerlUseXV1'] == 1) {
                            echo "<a href=\"video_gallery/display.php\">
<img style=\"border: none;\" src=\"images/icon_programs_edit.png\" vspace=\"5\" width=\"70\"/><br />عرض، تعديل ومسح البرامج</a>";
                        } else {
                            echo "<img onclick=\"return permission();\" style=\"border: none;\" src=\"images/icon_programs_edit_off.png\" vspace=\"5\" width=\"70\"/><br />عرض، تعديل ومسح البرامج";
                        }
                        ?>
                    </td>
                    ...
                    <td class="tableCellHome" width="200" align="center" valign="middle">
                        <?php
                        if ($_SESSION['permission_programsDay_GenerlUseXV1'] == 1) {
                            echo "<a href=\"programs_day/index.php\">
<img style=\"border: none;\" src=\"images/icon_programsDay.png\" vspace=\"5\" width=\"70\"/><br />إضافة برنامج لهاذا اليوم</a>";
                        } else {
                            echo "<img onclick=\"return permission();\" style=\"border: none;\" src=\"images/icon_programsDay_off.png\" vspace=\"5\" width=\"70\"/><br />إضافة لهاذا اليوم";
                        }
                        ?>
                    </td>
                    <td class="tableCellHome" width="200" align="center" valign="middle">
                        <?php
                        if ($_SESSION['permission_programsDay_GenerlUseXV1'] == 1) {
                            echo "<a href=\"programs_day/display.php\">
<img style=\"border: none;\" src=\"images/icon_programsDay_edit.png\" vspace=\"5\" width=\"70\"/><br />عرض، تعديل ومسح البرامج</a>";
                        } else {
                            echo "<img onclick=\"return permission();\" style=\"border: none;\" src=\"images/icon_programsDay_edit_off.png\" vspace=\"5\" width=\"70\"/><br />عرض، تعديل ومسح البرامج";
                        }
                        ?>
                    </td>
                </tr>
                <tr>
                    <td class="tableCellHome" width="200" align="center" valign="middle">
                        <?php
                        if ($_SESSION['permission_questionnaire_GenerlUseXV1'] == 1) {
                            echo "<a href=\"questionnaire/index.php\">
<img style=\"border: none;\" src=\"images/icon_questionnaire.png\" vspace=\"5\" width=\"70\"/><br />إضافة إستفتاء</a>";
                        } else {
                            echo "<img onclick=\"return permission();\" style=\"border: none;\" src=\"images/icon_questionnaire_off.png\" vspace=\"5\" width=\"70\"/><br />إضافة إستفتاء";
                        }
                        ?>
                    </td>
                    <td class="tableCellHome" width="200" align="center" valign="middle">
                        <?php
                        if ($_SESSION['permission_questionnaire_GenerlUseXV1'] == 1) {
                            echo "<a href=\"questionnaire/display.php\">
<img style=\"border: none;\" src=\"images/icon_questionnaire_edit.png\" vspace=\"5\" width=\"70\"/><br />عرض، تعديل ومسح ألاستفتائات</a>";
                        } else {
                            echo "<img onclick=\"return permission();\" style=\"border: none;\" src=\"images/icon_questionnaire_edit_off.png\" vspace=\"5\" width=\"70\"/><br />عرض، تعديل ومسح الاستفتائات";
                        }
                        ?>
                    </td>
                    <td class="tableCellHome" width="200" align="center" valign="middle">
                ...
                <tr>
                    <td class="tableCellHome" width="200" align="center" valign="middle">
                        ...
                        if ($_SESSION['permission_advertising_GenerlUseXV1'] == 1) {
                            echo "<a href=\"advertising/index.php\">
<img style=\"border: none;\" src=\"images/icon_advertising.png\" vspace=\"5\" width=\"70\"/><br />إضافة إعلان</a>";
                        } else {
                            echo "<img onclick=\"return permission();\" style=\"border: none;\" src=\"images/icon_advertising_off.png\" vspace=\"5\" width=\"70\"/><br />إضافة إعلان";
                        }
                        ?>
                    </td>
                    ...
                    <td class="tableCellHome" width="200" align="center" valign="middle">
                        <?php
                        if ($_SESSION['permission_advertising_GenerlUseXV1'] == 1) {
                            echo "<a href=\"advertising/display.php\">
<img style=\"border: none;\" src=\"images/icon_advertising_edit.png\" vspace=\"5\" width=\"70\"/><br />عرض، تعديل ومسح الإعلانات</a>";
                        } else {
                            echo "<img onclick=\"return permission();\" style=\"border: none;\" src=\"images/icon_advertising_edit_off.png\" vspace=\"5\" width=\"70\"/><br />عرض، تعديل ومسح الاإعلانات";
                        }
                        ?>
                    </td>
