...
// Insert permission
if ($_SESSION['permission_insert_GenerlUseXV1'] != 1 && $_SESSION['permission_subtitle_GenerlUseXV1'] != 1) {
    reDirect("../home.php");
}
    ...
    <div id="wrapper">
        <div class="user_info_area">
            ...
            <div class="navigation_bar">
                <a href="display.php"><img title="عرض وتعديل الاشرطة المتحركة" style="border: none;" align="absmiddle" src="../images/icon_subtitle_edit.png" width="40" /></a>
            </div><!-- // Navigation Bar -->
        ...
        <div id="main">
            <?php
            if (isset($_POST['inserting_subtitle'])) {
                ...
                if (mysqli_query($serverConnection, "INSERT INTO `subtitle` (`subtitle_id`, `title`, `display`, `creation`) VALUES (NULL, '$title', '$display', CURRENT_TIMESTAMP);")) {
                    echo "<h2 align=\"center\" style=\"color: #F00;\">تم حفظ الشريط الاخباري \"" . $title . "\"</h2>";
                } else {
                    echo "<h2 align=\"center\" style=\"color: #F00;\">لم يتم حفظ الشريط الاخباري! \"" . $title . "\"</h2>";
                }
            }
            ?>
            <table border="0" cellspacing="0" cellpadding="0" width="940">
                <!-- News Section -->
                <tr>
                    <td class="section" colspan="4">إضافة شريط إخباري</td>
                </tr>
            </table>

            <form action="" method="post" enctype="multipart/form-data" name="userInfo">
                <table style="margin-left:30px; margin-bottom:30px; margin-top:30px" border="0" cellspacing="10" cellpadding="5" width="870">
                    <tr valign="top">
                        <td style="text-wrap: none;">عنوان الشريط:</td>
                        <td><input class="bigTextField" name="title" id="title" type="text" size="35" /></td>
                    </tr>
                    <tr valign="top">
                        <td>عرض الشريط:</td>
                    ...
                    <tr valign="top" align="left">
                        <td colspan="2">
                            <input type="submit" name="inserting_subtitle" value="إضافة شريط الاخباري" /></td>
                    </tr>
                </table>
            </form>
        </div><!-- // Main -->
