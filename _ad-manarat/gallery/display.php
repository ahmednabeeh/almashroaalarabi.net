...
<body>
    <div id="wrapper">
        ...
        <div id="main">
            ...
            if (isset($_GET['gallery_id']) && isset($_GET['operation'])) {
                $gallery_id = filter_input(INPUT_GET, 'gallery_id', FILTER_SANITIZE_NUMBER_INT);
                $operation = filter_input(INPUT_GET, 'operation', FILTER_SANITIZE_STRING);


                if ($operation == "hide") {
                    mysqli_query($serverConnection, "UPDATE `gallery` SET `display` = 0 WHERE `gallery_id` = $gallery_id;");
                    echo "<h2 align=\"center\">تم أخفاء العنصر بنجاح</h2>";
                } elseif ($operation == "show") {
                    mysqli_query($serverConnection, "UPDATE `gallery` SET `display` = 1 WHERE `gallery_id` = $gallery_id;");
                    echo "<h2 align=\"center\">تم عرض العنصر بنجاح</h2>";
                } elseif ($operation == "hide_phone") {
                    mysqli_query($serverConnection, "UPDATE `gallery` SET `display_phone` = 0 WHERE `gallery_id` = $gallery_id;");
                    echo "<h2 align=\"center\">تم أخفاء العنصر عن برامج الهاتف</h2>";
                } elseif ($operation == "show_phone") {
                    mysqli_query($serverConnection, "UPDATE `gallery` SET `display_phone` = 1 WHERE `gallery_id` = $gallery_id;");
                    echo "<h2 align=\"center\">تم إضهار العنصر عن برنامج الهاتف</h2>";
                } elseif ($operation == "delete") {
                    mysqli_query($serverConnection, "UPDATE `gallery` SET `display` = 2 WHERE `gallery_id` = $gallery_id;");
            ...
            <table border="0" cellspacing="0" cellpadding="5" width="940">
                <tr class="table_header">
                    ...
                    <td width="50" align="center">أضافة صورة</td>
                    <td width="50" align="center">صور الاليوم</td>
...
// Display News
                $counter = 1;
                if (mysqli_num_rows(mysqli_query($serverConnection, "SELECT * FROM `gallery` WHERE `display` IN(0,1)")) == 0) {
                    echo "<tr><td colspan=\"10\"><h2 align=\"center\">لايوجد البومات</h2></td></tr>";
                }

// Check to default display
                else {
                    $displayGalleryArray = mysqli_query($serverConnection, "SELECT * FROM `gallery` WHERE `display` IN(0,1) ORDER BY `gallery_id` DESC LIMIT 50");
                    while ($displayGalleryArrayResult = mysqli_fetch_array($displayGalleryArray)) {
                        ...
                        if ($displayGalleryArrayResult['display'] == 1) {
                            echo "<a href=\"display.php?gallery_id=" . $displayGalleryArrayResult['gallery_id'] . "&operation=hide\"><img src=\"../images/icon_display_on.png\" width=\"20\" /></a>";
                        } else {
                            echo "<a href=\"display.php?gallery_id=" . $displayGalleryArrayResult['gallery_id'] . "&operation=show\"><img src=\"../images/icon_display_off.png\" width=\"20\" /></a>";
                        }
                        echo "</td>";
                        ...
                        if ($displayGalleryArrayResult['display_phone'] == 1) {
                            echo "<a href=\"display.php?gallery_id=" . $displayGalleryArrayResult['gallery_id'] . "&operation=hide_phone\"><img src=\"../images/icon_phone_on.png\" width=\"20\" /></a>";
                        } else {
                            echo "<a href=\"display.php?gallery_id=" . $displayGalleryArrayResult['gallery_id'] . "&operation=show_phone\"><img src=\"../images/icon_phone_off.png\" width=\"20\" /></a>";
                        }
                        echo "</td>";
                        ...
                        //Insert
                        echo "<td align=\"center\">" . "<a href=\"insert_images.php?gallery_id=" . $displayGalleryArrayResult['gallery_id'] . "\" target=\"_blank\">" . "<img src=\"../images/icon_gallery_images_insert.png\" width=\"25\" />" . "</a>" . "</td>";

                        // Display Preview
                        echo "<td align=\"center\">" . "<a href=\"display_gallery.php?gallery_id=" . $displayGalleryArrayResult['gallery_id'] . "\" target=\"_blank\">" . "<img src=\"../images/icon_gallery_images_edit.png\" width=\"25\" />" . "</a>" . "</td>";

                        // Modify
                        echo "<td align=\"center\">";
                        if ($_SESSION['permission_update_GenerlUseXV1'] == 1) {
                            echo "<a href=\"modify.php?gallery_id=" . $displayGalleryArrayResult['gallery_id'] . "\"><img src=\"../images/icon_modify.png\" width=\"25\" /></a>";
                        } else {
                        ...
                        if ($_SESSION['permission_delete_GenerlUseXV1'] == 1) {
                            echo "<a href=\"display.php?gallery_id=" . $displayGalleryArrayResult['gallery_id'] . "&operation=delete\"><img src=\"../images/icon_delete.png\" width=\"25\" /></a>";
                        } else {
