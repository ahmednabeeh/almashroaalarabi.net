    ...
    <div id="wrapper">
        ...
        <div id="main">
            ...
            if (isset($_POST['update_news'])) {
                ...
                $updatePdfPath = getUpdatedPdfPath();
                ...
                if (mysqli_query($serverConnection, "UPDATE `news` SET `title` = '$title', `editor` = '$editor', `content` = '$content', `image` = '$updateImagePath', `pdf` = '$updatePdfPath', `video_youtube` = '$videoYoutube', `category` = '$category', `display` = $display, `display_phone` = $display_phone, `comments` = $comments WHERE `news_id` = $news_id")) {
                ...
                <table style="margin-left:30px; margin-bottom:30px; margin-top:30px" border="0" cellspacing="10" cellpadding="5" width="850">
                    ...
                    <tr valign="top" align="left">
                        <td colspan="2">
                            ...
                            <input type="hidden" name="pdf_path" value="<?php echo $modifyNewsResult['pdf']; ?>" />
